{{-- <x-guest-layout>
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div>
                <x-jet-label for="login" value="{{ __('Email / User Name') }}" />
    ...
    <div class="card-body">
      ...
      <form method="POST" action="{{ route('login') }}">
        ...
        <div class="input-group mb-3">
            <label for="login" value="Email / User Name"></label>
          <input id="login" type="text" name="login" :value="old('login')" class="form-control" placeholder="Email/User Name"  required autofocus>
