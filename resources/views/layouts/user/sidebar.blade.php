                        ...
                        <div class="block block-anav">
                            ...
                            <ul style="" class="nav-accordion">
                                ...
                                <li class="level0 nav-1 first active level-top parent">
                                    <a href="#" class="level-top"><span>{{ $c->category }}</span></a>
                            ...
                            <dl id="narrow-by-list">
                                ...
                                <dd class="even">
                                    <ol class="configurable-swatch-list">
                                        <li> <a href="#" class="swatch-link has-image"> <span class="swatch-label"> <img src="assets/images/black.png" alt="Black" title="Black" height="15" width="15"> </span> <span class="count">Black(2)</span> </a></li>
                                        <li> <a href="#" class="swatch-link has-image"> <span class="swatch-label"> <img src="assets/images/blue.png" alt="Blue" title="Blue" height="15" width="15"> </span> <span class="count">Blue(4)</span> </a></li>
                                        <li> <a href="#" class="swatch-link has-image"> <span class="swatch-label"> <img src="assets/images/blue.png" alt="Blue" title="Blue" height="15" width="15"> </span> <span class="count">Blue(2)</span> </a></li>
                                        <li> <a href="#" class="swatch-link has-image"> <span class="swatch-label"> <img src="assets/images/indigo.png" alt="Indigo" title="Indigo" height="15" width="15"> </span> <span class="count">Indigo(1)</span> </a></li>
                                        <li> <a href="#" class="swatch-link has-image"> <span class="swatch-label"> <img src="assets/images/orange.png" alt="orange" title="orange" height="15" width="15"> </span> <span class="count">orange(1)</span> </a></li>
                                        <li> <a href="#" class="swatch-link has-image"> <span class="swatch-label"> <img src="assets/images/pink.png" alt="pink" title="pink" height="15" width="15"> </span> <span class="count">pink(2)</span> </a></li>
                                        <li> <a href="#" class="swatch-link has-image"> <span class="swatch-label"> <img src="assets/images/red.png" alt="Red" title="Red" height="15" width="15"> </span> <span class="count">Red(4)</span> </a></li>
                                        <li> <a href="#" class="swatch-link has-image"> <span class="swatch-label"> <img src="assets/images/taupe.png" alt="Taupe" title="Taupe" height="15" width="15"> </span> <span class="count">Taupe(1)</span> </a></li>
                                        <li> <a href="#" class="swatch-link has-image"> <span class="swatch-label"> <img src="assets/images/yellow.png" alt="yellow" title="yellow" height="15" width="15"> </span> <span class="count">yellow(2)</span> </a></li>
                                    </ol>
                                </dd>
